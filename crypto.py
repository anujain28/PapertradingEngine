...
def apply_crypto_styles():
    st.markdown("""
        ...
        /* 3. INPUTS & DROPDOWNS (Main Page - Force Visibility) */
        /* Selectbox Container */
        ...
        /* 4. TABLES & EXPANDERS */
        /* Force Tables to be White with Black Text */
...
def show_crypto_manual_bot_page():
    ...
    with c1:
        # Selection Box (Styling handled by apply_crypto_styles)
